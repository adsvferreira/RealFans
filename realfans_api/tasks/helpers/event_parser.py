from realfans_api.data.models import UserAdded, Donation, Redemption, BadgeMinted
...
def parse_donation_event(event):
    event_args = event.args
    return Donation(
        event_args.donator, event_args.receiverTwitterHandle, event_args.giftURI, event_args.ethValue, False
    )
